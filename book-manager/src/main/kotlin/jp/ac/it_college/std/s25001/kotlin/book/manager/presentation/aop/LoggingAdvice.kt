package jp.ac.it_college.std.s25001.kotlin.book.manager.presentation.aop

import jp.ac.it_college.std.s25001.kotlin.book.manager.application.service.security.BookManagerUserDetails
...
@Component
class LoggingAdvice {
    @Before("execution(* jp.ac.it_college.std.s25001.kotlin.book.manager.presentation.controller.*.*(..))")
    ...
    @After("execution(* jp.ac.it_college.std.s25001.kotlin.book.manager.presentation.controller.*.*(..))")
    fun afterLog(joinPoint: JoinPoint) {
        val user = SecurityContextHolder.getContext().authentication?.principal as BookManagerUserDetails
        logger.info("End: ${joinPoint.signature} userId: ${user.id}")
    }

    @Around("execution(* jp.ac.it_college.std.s25001.kotlin.book.manager.presentation.controller.*.*(..))")
    ...
    @AfterReturning(
        "execution(* jp.ac.it_college.std.s25001.kotlin.book.manager.presentation.controller.*.*(..))",
