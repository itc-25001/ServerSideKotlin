...
import jp.ac.it_college.std.s25001.kotlin.book.manager.application.service.AdminBookService
import jp.ac.it_college.std.s25001.kotlin.book.manager.domain.model.Book
import jp.ac.it_college.std.s25001.kotlin.book.manager.presentation.form.RegisterBookRequest
import jp.ac.it_college.std.s25001.kotlin.book.manager.presentation.form.UpdateBookRequest
...
class AdminBookController(
    ...
    @PutMapping("/update")
    open fun update(@RequestBody request: UpdateBookRequest) {
        request.run {
            adminBookService.update(id, title, author, releaseDate)
        }
    }
    @DeleteMapping("/delete/{bookId}")
    open fun delete(@PathVariable bookId: Long) {
